...
('Pink Floyd', 'The Dark Side of the Moon', 1972, 24.2, 'Progressive Rock'),
('Whitney Houston', 'The Bodyguard',1992, 27.4, 'R&B'),
  ('Meat Loaf', 'Bat our of Hell', 1977, 21.5, 'Hard Rock'),
  ...
  ('Michael Jackson', 'Bad', 1987, 23.6, 'Pop'),
  ...
  ('Michael Jackson', 'Dangerous', 1991, 19.4, 'Rock'),
